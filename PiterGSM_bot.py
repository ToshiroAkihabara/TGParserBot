...
async def main() -> None:
    try:
        ...
        async def help(message: types.Message):
            await message.answer_sticker('CAACAgIAAxkBAAEKC-lk3T7zeZwNYao4LRNikgdLI87O7AAClyAAAt88OUtsjjyKWQ5bXjAE')
        ...
        async def empty(message: types.Message):
            await message.answer('Нажмите "Запустить" для начала работы или напишите /help', reply_markup=user_markups.starts())
